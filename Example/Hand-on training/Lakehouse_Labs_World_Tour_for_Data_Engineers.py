...
# MAGIC rm -rf /dbfs/FileStore/uszips
# MAGIC mkdir /dbfs/FileStore/uszips
# MAGIC cd /dbfs/FileStore/uszips
...
# MAGIC %fs ls 'dbfs:/FileStore/uszips/'

# COMMAND ----------

# DBTITLE 1,Let's take a sneak peak at the file we'll be working with
# MAGIC %fs head 'dbfs:/FileStore/uszips/uszips.csv'
...
# MAGIC %md
# MAGIC ### ANALYZE TABLE
# MAGIC The ANALYZE TABLE statement collects statistics on a table. Statistics are to be used by the query optimizer to find the best query execution plan

# COMMAND ----------

# MAGIC %sql
# MAGIC ANALYZE TABLE population.city COMPUTE STATISTICS;
